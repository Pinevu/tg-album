...
export const createAlbum = (name: string, visibility: string, parent_id?: number, slug?: string, access_password?: string) => api.post('/albums', { name, visibility, parent_id, slug, access_password })
export const updateAlbum = (id: number, name: string, visibility: string, slug?: string, access_password?: string) => api.put(`/albums/${id}`, { name, visibility, slug, access_password })
