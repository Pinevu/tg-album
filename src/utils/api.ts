...
export const createAlbum = (name: string, visibility: string, parent_id?: number, slug?: string, access_password?: string, pwa_icon_url?: string, pwa_splash_image_url?: string) => api.post('/albums', { name, visibility, parent_id, slug, access_password, pwa_icon_url, pwa_splash_image_url })
export const updateAlbum = (id: number, name: string, visibility: string, slug?: string, access_password?: string, pwa_icon_url?: string, pwa_splash_image_url?: string) => api.put(`/albums/${id}`, { name, visibility, slug, access_password, pwa_icon_url, pwa_splash_image_url })
