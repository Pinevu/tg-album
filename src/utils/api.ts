...
export const createAlbum = (name: string, parent_id?: number) => api.post('/albums', { name, parent_id })
export const updateAlbum = (id: number, name: string, parent_id?: number) => api.put(`/albums/${id}`, { name, parent_id })
